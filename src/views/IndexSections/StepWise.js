...
const carouselItems = [
  {
    src: "https://static.dribbble.com/users/5462144/screenshots/11961113/media/4841dad66f05d4e477b729b2ff59a19e.jpg",
    altText: "Slide 1",
    caption: "Big City Life, United States",
  },
  {
    src: "https://www.startus.cc/sites/default/files/styles/company_profile_gallery_image/public/company-profile-gallery/whatsapp_image_2019-12-10_at_15.51.14.jpeg?itok=zyDIyTXm",
    altText: "Slide 2",
      ...
      <div className="section bg">
        <Container>
          <Row className="justify-content-between align-items-center">
            <Col className="mb-5 mb-lg-0" lg="5">
              <h1 className="text-white font-weight-light" style={{fontSize: "30px"}}>About Celesta</h1>
        ...
        <Container>
          <Row className="justify-content-between align-items-center">
            <Col lg="6">
              <div className="img1">
            <img src="https://scontent.fymy1-2.fna.fbcdn.net/v/t1.0-9/s720x720/101978522_3872924689389511_4004849801412739072_o.jpg?_nc_cat=110&_nc_sid=110474&_nc_eui2=AeEXr0cW4bXjRFxI-RrAL8GvRBEGVoeD7J9EEQZWh4Psn5AA47NMmUJPYV2OVsZc5dY&_nc_ohc=NVTwC6tToNgAX92yM8i&_nc_ht=scontent.fymy1-2.fna&_nc_tp=7&oh=032bcdb75bfb8087fc3cc18ab1ec9191&oe=5F4A6300" rounded />
            </div> <br />
              <br />
            </Col>

            <Col className="mb-5 mb-lg-0" lg="5">
              <h1 className="text-white font-weight-light" style={{fontSize: "30px"}}>CA Program</h1>
              <p className="text-white mt-4">
