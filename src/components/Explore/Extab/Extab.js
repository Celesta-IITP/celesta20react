        ...
        <div className='white tl tabs'>
          <Tabs defaultTab="one" className='tab-content mv2'>
            ...
            <TabPanel tabId="one">
              ...
              <p className='eventPrizes' dangerouslySetInnerHTML={{__html: event.charge}}>
              </p>
              ...
              <p className='eventHead' dangerouslySetInnerHTML={{__html: event.registrationUrl}}>
              </p>
              <div className='f3 underline b'>Date</div>

              <p className='eventHead' dangerouslySetInnerHTML={{__html: event.date}}>
              </p>
              <div className='f3 underline b'>Start Time</div>

              <p className='eventHead' dangerouslySetInnerHTML={{__html: event.startTime}}>
              </p>
              <div className='f3 underline b'>End Time</div>

              <p className='eventHead' dangerouslySetInnerHTML={{__html: event.endTime}}>
              </p>
            </TabPanel>
            <TabPanel tabId="two">                
              <div className='f3 b underline'>Rules</div>
              <div className='eventRules'>
                <ul dangerouslySetInnerHTML={{__html: event.rulebookUrl}}>
                </ul>
              </div>
            </TabPanel>
